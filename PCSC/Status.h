    ...
    public:
        ...
        inline HRESULT translate() const {
            switch (mValue) {
                ...
                case SCARD_E_CANCELLED:               return WFS_ERR_CANCELED;          // _HRESULT_TYPEDEF_(0x80100002L)
                case SCARD_E_INVALID_HANDLE:          return WFS_ERR_INVALID_HSERVICE;  // _HRESULT_TYPEDEF_(0x80100003L)
                case SCARD_E_INVALID_PARAMETER:       return WFS_ERR_INVALID_POINTER;   // _HRESULT_TYPEDEF_(0x80100004L)
                case SCARD_E_INVALID_TARGET:          return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x80100005L)
                case SCARD_E_NO_MEMORY:               return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x80100006L)
                case SCARD_F_WAITED_TOO_LONG:         return WFS_ERR_TIMEOUT;          // _HRESULT_TYPEDEF_(0x80100007L)
                case SCARD_E_INSUFFICIENT_BUFFER:     return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x80100008L)
                case SCARD_E_UNKNOWN_READER:          return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x80100009L)
                ...
                case SCARD_E_NO_SMARTCARD:            return WFS_ERR_DEV_NOT_READY;     // _HRESULT_TYPEDEF_(0x8010000CL)
                case SCARD_E_UNKNOWN_CARD:            return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x8010000DL)
                case SCARD_E_CANT_DISPOSE:            return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x8010000EL)
                case SCARD_E_PROTO_MISMATCH:          return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x8010000FL)
                case SCARD_E_NOT_READY:               return WFS_ERR_DEV_NOT_READY;     // _HRESULT_TYPEDEF_(0x80100010L)
                case SCARD_E_INVALID_VALUE:           return WFS_ERR_INVALID_POINTER;   // _HRESULT_TYPEDEF_(0x80100011L)
                case SCARD_E_SYSTEM_CANCELLED:        return WFS_ERR_CANCELED;          // _HRESULT_TYPEDEF_(0x80100012L)
                case SCARD_F_COMM_ERROR:              return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x80100013L)
                case SCARD_F_UNKNOWN_ERROR:           return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x80100014L)
                case SCARD_E_INVALID_ATR:             return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x80100015L)
                case SCARD_E_NOT_TRANSACTED:          return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x80100016L)
                case SCARD_E_READER_UNAVAILABLE:      return WFS_ERR_CONNECTION_LOST;   // _HRESULT_TYPEDEF_(0x80100017L)
                case SCARD_P_SHUTDOWN:                return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x80100018L)
                case SCARD_E_PCI_TOO_SMALL:           return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x80100019L)
                case SCARD_E_READER_UNSUPPORTED:      return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x8010001AL)
                case SCARD_E_DUPLICATE_READER:        return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x8010001BL)
                case SCARD_E_CARD_UNSUPPORTED:        return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x8010001CL)
                case SCARD_E_NO_SERVICE:              return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x8010001DL)
                case SCARD_E_SERVICE_STOPPED:         return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x8010001EL)
                case SCARD_E_UNEXPECTED:              return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x8010001FL)
                case SCARD_E_ICC_INSTALLATION:        return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x80100020L)
                case SCARD_E_ICC_CREATEORDER:         return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x80100021L)
                case SCARD_E_UNSUPPORTED_FEATURE:     return WFS_ERR_UNSUPP_COMMAND;    // _HRESULT_TYPEDEF_(0x80100022L)
                case SCARD_E_DIR_NOT_FOUND:           return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x80100023L)
                case SCARD_E_FILE_NOT_FOUND:          return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x80100024L)
                case SCARD_E_NO_DIR:                  return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x80100025L)
                case SCARD_E_NO_FILE:                 return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x80100026L)
                case SCARD_E_NO_ACCESS:               return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x80100027L)
                case SCARD_E_WRITE_TOO_MANY:          return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x80100028L)
                case SCARD_E_BAD_SEEK:                return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x80100029L)
                case SCARD_E_INVALID_CHV:             return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x8010002AL)
                case SCARD_E_UNKNOWN_RES_MNG:         return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x8010002BL)
                case SCARD_E_NO_SUCH_CERTIFICATE:     return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x8010002CL)
                case SCARD_E_CERTIFICATE_UNAVAILABLE: return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x8010002DL)
                case SCARD_E_NO_READERS_AVAILABLE:    return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x8010002EL)
                case SCARD_E_COMM_DATA_LOST:          return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x8010002FL)
                case SCARD_E_NO_KEY_CONTAINER:        return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x80100030L)
                case SCARD_E_SERVER_TOO_BUSY:         return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x80100031L)
                case SCARD_W_UNSUPPORTED_CARD:        return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x80100065L)
                case SCARD_W_UNRESPONSIVE_CARD:       return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x80100066L)
                case SCARD_W_UNPOWERED_CARD:          return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x80100067L)
                case SCARD_W_RESET_CARD:              return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x80100068L)
                case SCARD_W_REMOVED_CARD:            return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x80100069L)
                case SCARD_W_SECURITY_VIOLATION:      return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x8010006AL)
                case SCARD_W_WRONG_CHV:               return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x8010006BL)
                case SCARD_W_CHV_BLOCKED:             return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x8010006CL)
                case SCARD_W_EOF:                     return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x8010006DL)
                case SCARD_W_CANCELLED_BY_USER:       return WFS_ERR_CANCELED;          // _HRESULT_TYPEDEF_(0x8010006EL)
                case SCARD_W_CARD_NOT_AUTHENTICATED:  return WFS_ERR_HARDWARE_ERROR;    // _HRESULT_TYPEDEF_(0x8010006FL)
                case SCARD_W_CACHE_ITEM_NOT_FOUND:    return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x80100070L)
                case SCARD_W_CACHE_ITEM_STALE:        return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x80100071L)
                case SCARD_W_CACHE_ITEM_TOO_BIG:      return WFS_ERR_INTERNAL_ERROR;    // _HRESULT_TYPEDEF_(0x80100072L)
                default:                              return WFS_ERR_INTERNAL_ERROR;
            }
        }
    };
} // namespace PCSC
